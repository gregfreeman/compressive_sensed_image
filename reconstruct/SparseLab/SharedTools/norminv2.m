...
if nargin<1
    error('results:norminv:TooFewInputs','Input argument P is undefined.');
end
if nargin < 2
    mu = 0;
end
...
try
    ...
    error('results:norminv:InputSizeMismatch',...
