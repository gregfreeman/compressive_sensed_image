function y = FastCSGenOperator(mode,m,n,x,I,dim)
% FastCSGenOperator: extension of Sparselab FastCSOperator to include
%   optional wavelet transform and foveation operator
